...
![img](images/1202586-20181211123717325-1261206014.png)

　　客户端必须设置正向代理服务器，当然前提是要知道正向代理服务器的IP地址，还有代理程序的端口。如图。

![img](images/1202586-20181211121039404-1910765480.png)
...
![img](images/1202586-20180406175939873-925019958.png)
...
![img](images/1202586-20180406180130452-1246060303.png)

## 二者区别

　　截了一张图来说明正向代理和反向代理二者之间的区别，如图。

![img](images/1202586-20181211122806997-940664368.png)
...
![img](images/1202586-20180406180405961-333776342.png)
...
4. url_hash：按照访问的url( 域名 )的hash结果分配请求，每个请求的url会指向后端固定的某个服务器，可以在Nginx作为静态服务器的情况下提高缓存效率。同样要注意Nginx默认不支持这种调度算法，要使用的话需要安装Nginx的hash软件包。
